...
function Settings({
  ...
  const selectedIndustry=profileFor(organization.industryProfile||(organization as any).IndustryProfile),selectedModules=enabledModules(organization.enabledModules||(organization as any).EnabledModules);
