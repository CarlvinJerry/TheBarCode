...
export const defaultOrganizationSettings:OrganizationSettings={name:"TheBarcode",industryProfile:"Hospitality",businessCategory:"BarCafe",enabledModules:"sales,inventory,expenses,reports,ai,production,accounting",profileConfigured:false,currency:"KES",tagline:"Smarter Business Operations"};
