export const APP_VERSION = import.meta.env.VITE_APP_VERSION || "1.12.15";
...
export const RELEASE_NOTES = [
  ...
  "Accounting source journals reconcile corrections through auditable correction entries",
  ...
  "Expanded the TheBarcode design standard with alignment, sentence-case, separator and anti-decoration rules",
  "Unified TheBarcode stroke icons replace mixed emoji and Unicode navigation symbols",
  ...
  "New TheBarcode design-engineering standard with purposeful, fast and accessible interaction feedback",
  ...
  "Smaller Powered by TheBarcode | Beyond Raw Data receipt footer",
  ...
  "TheBarcode Lite desktop edition with embedded SQLite storage",
  ...
  "Rebranded as TheBarcode — Smarter Business Operations",
