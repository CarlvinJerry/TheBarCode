...
public static class ExpenseEndpoints
{
    ...
    {
        var api=app.MapGroup("/api/expenses").RequireAuthorization(p=>p.RequireRole("Owner","Manager","Auditor"));
