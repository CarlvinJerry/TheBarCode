...
Installer: `installer\output\Dukora-Lite-Setup-1.5.0-x64.exe`
...
No PostgreSQL password, Docker, firewall rule or Windows service is required. WebView2 is checked by setup using Microsoft's official Evergreen bootstrapper.
