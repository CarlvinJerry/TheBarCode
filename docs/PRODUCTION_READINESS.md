...
Version 1.12.12 adds reliable elevated native installation/configuration and safe Lite-to-PostgreSQL upgrade detection on top of the production hardening pass.
